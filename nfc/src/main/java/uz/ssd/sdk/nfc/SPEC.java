...
public final class SPEC {
    ...
    public static String getCityUnionCardNameByZipcode(String zip, Context context) {
        byte[] tree = zip2CityName;
        if (tree == null) {
            tree = loadRawResource(R.raw.zip, context);
            zip2CityName = tree;
        }
            ...
            if (pos != 0) {
                ...
                if (len > 0) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
                        name = new String(tree, pos + 31, len, StandardCharsets.UTF_8);
                    }
    ...
    public static byte[] loadRawResource(int resId, Context context) {
        InputStream is = null;
        try {
